    ...
    return(
        <footer className="bg-black/20">
            <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
                ...
                <div
                    className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-3 rounded-xl p-6 backdrop-blur-sm bg-black/10"
                >
                    <div className="text-center sm:text-left">
                        <p className="text-lg font-montserrat font-medium text-momo">О нас</p>
                ...
                <div className="text-center sm:flex sm:justify-between sm:text-left">
                    ...
                    <a
                        className="inline-block text-white/80 underline transition hover:text-blue-800"
                        href="/"
                    >
